...
use Admin\Http\Controllers\PersonController;
use Admin\Http\Controllers\RedirectController;
...
Route::group([
    ...
    // settings
    Route::post('/reset-system', [SettingController::class, 'resetSystem'])->name('settings.reset');
